...
function draw() {  
  ...
  if (img) {   
    ...
    for(let y = 0;y < 25;y+=1){
      ...
      if (SumRed < 101 && SumGreen < 101 && SumBlue > 100){CharCol=[0,0,200];cout = cout + '$0e'}
      ...
      if (SumRed < 101 && SumGreen > 100 && SumBlue > 100){CharCol=[0,200,200];cout = cout + '$05'}
      if (SumRed > 100 && SumGreen > 100 && SumBlue > 100){CharCol=[200,200,200];cout = cout + '$0f'}
      byte = 0;
      if (test[0] > 32){byte += 1}
      if (test[1] > 32){byte += 2}
      if (test[2] > 32){byte += 4}
      ...
      if(byte == 26 || byte == 30){ pout = pout + '$e9';Blank = false;fill(CharCol);
